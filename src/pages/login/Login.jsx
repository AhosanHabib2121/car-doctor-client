        ...
        <div className="hero min-h-screen ">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className="card flex-shrink-0 w-full max-w-sm border border-[#D0D0D0]">
                    <h1 className="text-[#444] text-4xl text-center font-semibold mt-8">Login</h1> 
                    <form onSubmit={handleLogin} className="card-body">
                        ...
                        <div className="form-control mt-6">
                            <input type="submit" className="btn bg-[#FF3811] text-white normal-case text-lg hover:bg-[#ad260b]" value='Login' />
                        </div>
                    </form>
                    <div className=' text-center mb-6'>
                        <p className=' text-base font-medium text-[#737373] '>Create a new account? <Link to='/signUp' className=' text-[#FF3811]'>Sign Up</Link></p>
                    </div>
                </div>
            </div>
        </div>
